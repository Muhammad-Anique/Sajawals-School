...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white max-w-screen-xl flex flex-row w-full justify-center  gap-24 px-16">
          <div className="flex flex-row gap-2 md:gap-6 items-center">
            <a
              href="https://wa.me/923157603891"
              className="flex flex-row items-center justify-center gap-1 sm:gap-2 scale-[0.9] md:scale-100"
            >
              <Whatsapp />
              <p className="font-extrabold text-sm sm:text-xl lg:text-2xl font-oswald text-black">
                +923157603891
              </p>
            </a>

            <a
              href="mailto:hello@sajawal.school"
      ...
      <p className="font-poppins text-sm text-center md:text-lg text-black mb-6  px-4 mt-8">
        <b>© Copyright</b> 2025 Sajawal.School. All Rights Reserved
      </p>
    </div>
  );
};
...
const Whatsapp = () => {
  return (
    <svg
      ...
      height={32}
      viewBox="0 0 448 512"
      className="fill-secondary scale-90 sm:scale-100"
      xmlns="http://www.w3.org/2000/svg"
    >
